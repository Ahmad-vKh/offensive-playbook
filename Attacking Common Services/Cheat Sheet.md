...
| `sqsh -S 10.129.84.127 -U htbdbuser -P 'MSSQLAccess01!' -h`                                                                | Connecting to the MSSQL server from Linux.                                                                    |
...
| `smtp-user-enum -M RCPT -U userlist.txt -D inlanefreight.htb -t 10.129.203.12`                                                                          | SMTP user enumeration using the RCPT command against the specified host.               |
